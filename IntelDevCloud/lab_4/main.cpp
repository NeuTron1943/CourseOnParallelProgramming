...
int main() {
    ...
    std::cout << "N        Time1     Time2      Time3" << std::endl;
    for (int num_elements = 64; num_elements < 100000000; num_elements*=2){
        std::cout<<  num_elements << "   ";
        for (int doesnt_matter = 0; doesnt_matter < 3; doesnt_matter++){
            ...
            for (int i = 0; i < num_elements; i++) {
                input_vect1.push_back(Complex2(2 * (i % 2), 3* (i % 2 + 1)));
                input_vect2.push_back(Complex2( 4,  6));
